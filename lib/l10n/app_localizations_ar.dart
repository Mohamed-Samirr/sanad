...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get noHabitsMessage => 'ابدأ بخطوة صغيرة واحدة تقدر تكررها بكرة. وتقدر تحوّل أي إجراء من صندوق أدواتك إلى عادة متابَعة.';
  ...
  String doneOfDueToday(int done, int due) {
    return 'أنجزت $done من $due اليوم';
  }

  @override
  String doneOfDueTodaySemantics(int done, int due) {
    return 'أنجزت $done من $due عادة اليوم';
  }
  ...
  @override
  String get removeThisHabitMessage => 'الأرشفة تحتفظ بالسجل وتخفي العادة من قائمتك. أما الحذف فيزيل كل يوم مسجَّل نهائيًا.';
  ...
  String trendUp(int points) {
    return 'أعلى بـ $points نقطة عن متوسط الأسبوع الماضي.';
  }

  @override
  String trendDown(int points) {
    return 'أقل بـ $points نقطة عن متوسط الأسبوع الماضي.';
  }
  ...
  @override
  String get notEnoughTrendData => 'سجّل أيامًا أكثر قليلًا وسيظهر خط المؤشر هنا.';
  ...
  String timesPerWeekExplain(int count) {
    return 'أي $count أيام تناسبك. اليوم لا يُحسب عليك إلا حين يصبح بلوغ الهدف في هذا الأسبوع غير ممكن.';
  }
  ...
  @override
  String get formStartDateLockedNote => 'تاريخ البداية يبقى كما هو حتى يحتفظ سجلك بشكله.';
  ...
  @override
  String get nothingLoggedYet => 'لا يوجد تسجيل بعد. اضغط على أي يوم في التقويم لتسجيله، وأضف ملاحظة إن كان هناك ما يستحق التذكر.';
  ...
  String moreInCalendar(int count) {
    return '+$count في التقويم بالأعلى.';
  }
  ...
  @override
  String get nothingArchivedMessage => 'العادات التي تؤرشفها تصل هنا بسجلها كاملًا. تقدر ترجّع أي واحدة منها في أي وقت.';
  ...
  String loggedDaysSince(int count, String date) {
    return '$count يوم مسجَّل · منذ $date';
  }
  ...
  String deleteWithHistoryMessage(int count) {
    return 'كل الأيام المسجَّلة لهذه العادة وعددها $count ستُحذف معها. هذا الجزء لا يمكن التراجع عنه.';
  }

  @override
  String get deleteNoHistoryMessage => 'هذه العادة ليس لها أيام مسجَّلة. ستُزال نهائيًا.';
  ...
  String permanentMessage(int count, String name) {
    return 'سيُمحى $count يوم مسجَّل. إن كنت تريد فقط إبعاد $name عن قائمتك، فهي مؤرشفة بالفعل — تقدر تسيبها هنا.';
  }
  ...
  String restoredMessage(String name) {
    return '$name رجعت إلى قائمتك.';
  }

  @override
  String deletedMessage(String name) {
    return 'تم حذف $name وسجلها.';
  }
  ...
  @override
  String get settingsArchivedDescription => 'استرجع واحدة، أو احذفها هي وسجلها.';

  @override
  String get settingsAboutSection => 'عن التطبيق';

  @override
  String get disclaimer => 'سند أداة للمتابعة الذاتية. هو ليس علاجًا طبيًا ولا يغني عن طبيب أو معالج. إن كان الأمر شديدًا أو غير آمن، فالحديث مع مختص هو الخطوة الصحيحة، واللجوء إليه ليس فشلًا في أي شيء بنيته هنا.';
  ...
  @override
  String get reminderPermissionDenied => 'تحتاج التنبيهات إلى إذن الإشعارات. يمكنك تشغيله في إعدادات جهازك والمحاولة مرة أخرى.';
